...
window.addEventListener('load', function(){
	...
	box2.addEventListener('touchmove', function(e){
		...
		box2.style.left = ( (boxleft + dist > 2000)? 2000 : (boxleft + dist < -1200)? -1200 : boxleft + dist ) + 'px';
		// e.preventDefault() 
	}, false);
	...
	if (!detecttouch){
		...
		document.body.addEventListener('mousemove', function(e){
			if (ismousedown){
				...
				box2.style.left = ( (boxleft + dist > 100)? 100 : (boxleft + dist < -1600)? -1600 : boxleft + dist ) + 'px';
				e.preventDefault();
			}
		}, false)
